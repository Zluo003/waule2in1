  ...
  return (
    <div className="h-full flex relative overflow-hidden bg-[#030014]">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[60%] bg-neutral-700/10 rounded-full blur-[130px]" />
      ...
      <div className="hidden lg:flex flex-1 flex-col justify-center px-12 xl:px-20 relative z-10">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-neutral-800 via-neutral-800 to-cyan-400 flex items-center justify-center shadow-lg shadow-neutral-800/30">
        ...
        <div className="mb-12 space-y-6">
          ...
          <h3 className="text-3xl xl:text-4xl font-bold">
            <span className="bg-gradient-to-r from-neutral-600 via-neutral-600 to-cyan-400 bg-clip-text text-transparent">
              不可思议的 AI 创作平台
            </span>
          </h3>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-500 ${
                activeFeature === index
                  ? 'bg-gradient-to-br from-neutral-800 to-neutral-800 shadow-lg shadow-neutral-800/30'
                  : 'bg-white/5'
              }`}>
              ...
              {activeFeature === index && (
                <div className="ml-auto">
                  <div className="w-2 h-2 rounded-full bg-gradient-to-r from-neutral-600 to-neutral-600 animate-pulse" />
                </div>
              )}
            </div>
          ))}
          ...
          <div className="bg-white/[0.03] backdrop-blur-2xl rounded-3xl border border-white/10 p-10 shadow-2xl">
            ...
            <div className="lg:hidden text-center mb-8">
              <div className="inline-flex items-center gap-2 mb-4">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-neutral-800 via-neutral-800 to-cyan-400 flex items-center justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-neutral-800/50 focus:border-neutral-800/50 transition-all"
                    placeholder="请输入手机号码"
                  />
                </div>
              </div>
              ...
              <div className="pt-4">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-4 bg-gradient-to-r from-neutral-800 via-neutral-800 to-neutral-800 bg-size-200 bg-pos-0 hover:bg-pos-100 text-white font-semibold rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-500 shadow-lg shadow-neutral-800/25 hover:shadow-neutral-800/40"
                >
                  {loading ? (
