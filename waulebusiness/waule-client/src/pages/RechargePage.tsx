...
const orderStatusLabels: Record<string, { text: string; color: string }> = {
  ...
  REFUNDED: { text: '已退款', color: 'text-neutral-800' },
...
const transactionTypeLabels: Record<string, { text: string; icon: string; color: string }> = {
  ...
  GIFT: { text: '赠送', icon: 'card_giftcard', color: 'text-neutral-800' },
    ...
    <div className="min-h-screen">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-purple-600 via-neutral-800 to-blue-500 dark:from-neutral-600 dark:via-neutral-600 dark:to-blue-400 bg-clip-text text-transparent mb-3">
            会员订阅
          </h1>
              ...
              >
                <div className="p-4">
                  ...
                  <div className="space-y-1.5 mb-4 text-sm">
                    ...
                    {pkg.memberLevel && (
                      <div className="flex items-center gap-2 text-purple-600 dark:text-neutral-600">
            ...
            <div className="max-w-6xl mx-auto flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  disabled={creating}
                  className="px-8 py-3 bg-gradient-to-r from-blue-500 to-neutral-800 hover:from-blue-600 hover:to-purple-600 text-white font-bold rounded-xl transition-all duration-300 disabled:opacity-50 shadow-lg shadow-blue-500/25"
                >
                  {creating ? '创建订单中...' : '立即支付'}
                </button>
              </div>
          ...
          <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-card-dark rounded-3xl w-full max-w-md overflow-hidden shadow-2xl">
              {paymentSuccess ? (
                ...
                // 支付中
                <>
                  <div className="bg-gradient-to-r from-blue-500 to-neutral-800 p-6 text-center text-white">
