  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* 统计卡片 */}
        <div className="bg-white dark:bg-[#18181b] border border-border-light dark:border-border-dark rounded-xl p-6 shadow-soft">
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <button className="bg-white dark:bg-[#18181b] border border-border-light dark:border-border-dark rounded-xl p-6 hover:border-tiffany-500 hover:shadow-tiffany transition-all text-left">
