        ...
        {isStoryboard ? (
              ...
              sbSections.map((sec, i) => (
                <div key={`sec-${i}`} className="pt-2">
                  ...
                  <textarea
                    ...
                    className="nodrag w-full bg-slate-100 dark:bg-[#000000] backdrop-blur-none border border-slate-200 dark:border-neutral-800 rounded-lg text-slate-800 dark:text-white text-sm p-2 resize-none whitespace-pre-wrap leading-snug focus:outline-none focus:border-neutral-400 dark:focus:border-neutral-400/50 transition-colors"
          ...
          <div ref={containerRef} className="flex flex-col pt-2 nowheel">
            <textarea
              ...
              className="nodrag nowheel w-full bg-slate-100 dark:bg-[#000000] backdrop-blur-none border border-slate-200 dark:border-neutral-800 rounded-lg text-slate-800 dark:text-white text-sm p-2 resize-none whitespace-pre-wrap break-words focus:outline-none focus:border-neutral-400 dark:focus:border-neutral-400/50 transition-colors scrollbar-hide"
            ...
            <button
              ...
              className="nodrag relative w-full mt-2 py-2 bg-neutral-800 dark:bg-white hover:shadow-lg disabled:from-gray-600 disabled:to-gray-700 disabled:opacity-50 text-white dark:text-black rounded-lg font-medium text-sm flex items-center justify-center gap-2 transition-all overflow-hidden flex-shrink-0"
            >
