...
exports.example1_BasicImageToVideo = example1_BasicImageToVideo;
exports.example2_LocalImage = example2_LocalImage;
exports.example3_WithAudio = example3_WithAudio;
exports.example4_RecommendedPrompt = example4_RecommendedPrompt;
exports.example5_OffPeakMode = example5_OffPeakMode;
exports.example6_AdvancedConfig = example6_AdvancedConfig;
exports.example7_QueryTaskStatus = example7_QueryTaskStatus;
exports.example8_CancelTask = example8_CancelTask;
exports.example9_BatchGeneration = example9_BatchGeneration;
exports.example10_ErrorHandling = example10_ErrorHandling;
const vidu_service_1 = require("./vidu.service");
/**
 * 示例 1: 基础图生视频
 */
async function example1_BasicImageToVideo() {
    console.log('\n=== 示例 1: 基础图生视频 ===');
    try {
        const videoUrl = await (0, vidu_service_1.imageToVideo)({
...
async function example7_QueryTaskStatus() {
    ...
    try {
        const taskStatus = await (0, vidu_service_1.queryTaskStatus)(taskId, apiKey);
...
async function example8_CancelTask() {
    ...
    const apiKey = 'your_api_key_here'; // 从管理后台获取
    try {
        await (0, vidu_service_1.cancelTask)(taskId, apiKey);
        console.log('✅ 任务已取消！');
    }
    catch (error) {
...
//# sourceMappingURL=vidu.service.example.js.map