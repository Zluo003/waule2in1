...
exports.PROVIDERS = exports.getDefaultApiUrl = exports.getPresetsByType = exports.getAllPresets = exports.AI_MODEL_PRESETS = exports.DEFAULT_API_URLS = void 0;
exports.DEFAULT_API_URLS = {
    ...
    audioSynthesis: [
        {
            ...
            apiKey: null,
            apiUrl: exports.DEFAULT_API_URLS.minimaxi,
            isActive: true,
            pricePerUse: '0.02',
        },
        {
        ...
        },
        {
            ...
            apiKey: null,
            apiUrl: exports.DEFAULT_API_URLS.aliyun,
            isActive: true,
            pricePerUse: '0.015',
        },
    ],
...
const getAllPresets = () => {
    return [
        ...exports.AI_MODEL_PRESETS.textGeneration,
        ...exports.AI_MODEL_PRESETS.imageGeneration,
        ...exports.AI_MODEL_PRESETS.videoGeneration,
        ...exports.AI_MODEL_PRESETS.audioSynthesis,
    ];
};
...
const getPresetsByType = (type) => {
    switch (type) {
        case 'TEXT_GENERATION':
            return exports.AI_MODEL_PRESETS.textGeneration;
        case 'IMAGE_GENERATION':
            return exports.AI_MODEL_PRESETS.imageGeneration;
        case 'VIDEO_GENERATION':
            return exports.AI_MODEL_PRESETS.videoGeneration;
        case 'AUDIO_SYNTHESIS':
            return exports.AI_MODEL_PRESETS.audioSynthesis;
        default:
            return [];
    }
};
...
const getDefaultApiUrl = (provider) => {
    return exports.DEFAULT_API_URLS[provider] || null;
};
exports.getDefaultApiUrl = getDefaultApiUrl;
// 提供商列表
exports.PROVIDERS = [
    { value: 'openai', label: 'OpenAI', defaultUrl: exports.DEFAULT_API_URLS.openai },
    { value: 'google', label: 'Google', defaultUrl: exports.DEFAULT_API_URLS.google },
    { value: 'bytedance', label: 'ByteDance (豆包)', defaultUrl: exports.DEFAULT_API_URLS.bytedance },
    { value: 'aliyun', label: '阿里云百炼', defaultUrl: exports.DEFAULT_API_URLS.aliyun },
    { value: 'stability', label: 'Stability AI', defaultUrl: exports.DEFAULT_API_URLS.stability },
    { value: 'runway', label: 'Runway', defaultUrl: exports.DEFAULT_API_URLS.runway },
    { value: 'midjourney', label: 'Midjourney', defaultUrl: exports.DEFAULT_API_URLS.midjourney },
    { value: 'pika', label: 'Pika', defaultUrl: exports.DEFAULT_API_URLS.pika },
    { value: 'sora', label: 'Sora', defaultUrl: exports.DEFAULT_API_URLS.sora },
    { value: 'minimaxi', label: 'MiniMax（海螺）', defaultUrl: exports.DEFAULT_API_URLS.minimaxi },
    { value: 'vidu', label: 'Vidu', defaultUrl: exports.DEFAULT_API_URLS.vidu },
    { value: 'other', label: '其他', defaultUrl: null },
];
//# sourceMappingURL=ai-models-presets.js.map