...
const ModelConfigPage = () => {
  ...
  const [sdream45ImageConfig, setSdream45ImageConfig] = useState({ supportedRatios: ASPECT_RATIOS.map(r => r.value), supportsImageToImage: true, supportsImageEditing: true, maxReferenceImages: 10 })
      ...
      try {
        ...
        if (gGemini3Image) {
          ...
          setGemini3ImageConfig({
            ...
            supportsImageEditing: gGemini3Image.config?.supportsImageEditing === true,
        ...
        if (sdream45) {
          ...
          setSdream45ImageConfig({
            ...
            supportsImageEditing: sdream45.config?.supportsImageEditing === true,
          ...
          setSdream45ImageConfig({ supportedRatios: ASPECT_RATIOS.map(r => r.value), supportsImageToImage: true, supportsImageEditing: true, maxReferenceImages: 10 })
        }
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-4">
            ...
            <div className="space-y-2">
              ...
              <button type="button" onClick={() => setSelectedKey('google_flash_text')} className={`w-full text-left p-3 rounded-lg border ${selectedKey === 'google_flash_text' ? 'border-slate-400 dark:border-slate-500 bg-slate-100 dark:bg-slate-700' : 'border-slate-200 dark:border-border-dark'} flex items-center justify-between`}>
                <div>
                  <div className="text-slate-900 dark:text-white">Gemini 2.5 Flash <span className="text-xs text-neutral-400">(视频分析)</span></div>
        ...
        <div className="md:col-span-2 space-y-8">
          {selectedKey === 'google_pro' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={proPrice} onChange={e => setProPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={proApiKey} onChange={e => setProApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={proApiUrl} onChange={e => setProApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultGoogleApiUrl(GOOGLE_PRO_ID)} />
                </div>
              </div>
              <div className="mt-6">
          ...
          {selectedKey === 'google_flash_text' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">Gemini 2.5 Flash <span className="text-neutral-500">(视频分析)</span></h2>
                <span className="text-xs px-2 py-0.5 rounded bg-slate-200 dark:bg-white/10 text-slate-700 dark:text-gray-300">TEXT_GENERATION</span>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={flashTextPrice} onChange={e => setFlashTextPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key *</label>
                  <input value={flashTextApiKey} onChange={e => setFlashTextApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="AIzaSy..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={flashTextApiUrl} onChange={e => setFlashTextApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultGoogleApiUrl(GOOGLE_FLASH_TEXT_ID)} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
              ...
              <div className="mt-6 p-4 bg-neutral-50 dark:bg-neutral-900/20 rounded-lg border border-neutral-200 dark:border-neutral-800">
                <div className="text-sm font-medium text-neutral-900 dark:text-neutral-300 mb-2">💡 专用于视频分析</div>
                <div className="text-xs text-neutral-700 dark:text-neutral-400">此模型用于"灵感/创意"页面的视频分镜分析功能，支持多模态输入（文本、图片、视频）</div>
              </div>
              <div className="mt-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
          ...
          {selectedKey === 'google_flash' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={flashPrice} onChange={e => setFlashPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={flashApiKey} onChange={e => setFlashApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={flashApiUrl} onChange={e => setFlashApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultGoogleApiUrl(GOOGLE_FLASH_IMAGE_ID)} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'google_gemini3' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={gemini3Price} onChange={e => setGemini3Price(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={gemini3ApiKey} onChange={e => setGemini3ApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={gemini3ApiUrl} onChange={e => setGemini3ApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultGoogleApiUrl(GOOGLE_GEMINI_3_ID)} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'google_gemini3_image' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={gemini3ImagePrice} onChange={e => setGemini3ImagePrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={gemini3ImageApiKey} onChange={e => setGemini3ImageApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={gemini3ImageApiUrl} onChange={e => setGemini3ImageApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultGoogleApiUrl(GOOGLE_GEMINI_3_IMAGE_ID)} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
              ...
              <div className="mt-6 space-y-6">
                ...
                <div className="flex items-start gap-3 p-3 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg">
                  <input type="checkbox" checked={gemini3ImageConfig.supportsImageEditing} onChange={e => setGemini3ImageConfig({ ...gemini3ImageConfig, supportsImageEditing: e.target.checked })} className="w-5 h-5" />
                  <div className="flex-1">
                    <div className="text-sm text-orange-900 dark:text-orange-300 font-medium">图片编辑（工作流节点）</div>
                    <div className="text-xs text-orange-700 dark:text-orange-400">启用后此模型可用于图片编辑节点，支持点标记精准编辑</div>
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">最大参考图数量</label>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="px-4 py-2 bg-neutral-50 dark:bg-neutral-900/20 border border-neutral-200 dark:border-neutral-800 rounded-lg">
                      <div className="text-sm text-neutral-900 dark:text-neutral-300 font-medium">✓ 推理能力</div>
                      <div className="text-xs text-neutral-700 dark:text-neutral-400">支持思维过程推理生成</div>
                    </div>
          ...
          {selectedKey === 'doubao_seedance_pro' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={sdProPrice} onChange={e => setSdProPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={sdProApiKey} onChange={e => setSdProApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="ak-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={sdProApiUrl} onChange={e => setSdProApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultDoubaoApiUrl} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'doubao_seedance_fast' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text.sm font-medium text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={sdFastPrice} onChange={e => setSdFastPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={sdFastApiKey} onChange={e => setSdFastApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="ak-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={sdFastApiUrl} onChange={e => setSdFastApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultDoubaoApiUrl} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'doubao_seedream' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={sdreamPrice} onChange={e => setSdreamPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={sdreamApiKey} onChange={e => setSdreamApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="ak-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={sdreamApiUrl} onChange={e => setSdreamApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultDoubaoApiUrl} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'doubao_seedream_45' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={sdream45Price} onChange={e => setSdream45Price(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={sdream45ApiKey} onChange={e => setSdream45ApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="ak-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={sdream45ApiUrl} onChange={e => setSdream45ApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultDoubaoApiUrl} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
              ...
              <div className="mt-6 space-y-6">
                ...
                <div className="flex items-start gap-3 p-3 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg">
                  <input type="checkbox" checked={sdream45ImageConfig.supportsImageEditing} onChange={e => setSdream45ImageConfig({ ...sdream45ImageConfig, supportsImageEditing: e.target.checked })} className="w-5 h-5" />
                  <div className="flex-1">
                    <div className="text-sm text-orange-900 dark:text-orange-300 font-medium">图片编辑（工作流节点）</div>
                    <div className="text-xs text-orange-700 dark:text-orange-400">启用后此模型可用于图片编辑节点，支持点标记精准编辑</div>
                  </div>
          ...
          {selectedKey === 'aliyun_qwen_image_edit' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={aliQwenImageEditPrice} onChange={e => setAliQwenImageEditPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={aliQwenImageEditApiKey} onChange={e => setAliQwenImageEditApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={aliQwenImageEditApiUrl} onChange={e => setAliQwenImageEditApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={`${defaultAliyunBase}/api/v1/services/aigc/multimodal-generation/generation`} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'aliyun_animate_move' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={aliMovePrice} onChange={e => setAliMovePrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={aliMoveApiKey} onChange={e => setAliMoveApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址（中国）</label>
                  <input value={aliMoveApiUrl} onChange={e => setAliMoveApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultAliyunImage2Video} />
                </div>
              </div>
              <div className="mt-6">
          ...
          {selectedKey === 'aliyun_animate_mix' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={aliMixPrice} onChange={e => setAliMixPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={aliMixApiKey} onChange={e => setAliMixApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址（中国）</label>
                  <input value={aliMixApiUrl} onChange={e => setAliMixApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultAliyunImage2Video} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">服务模式（可多选）</div>
          ...
          {selectedKey === 'aliyun_video_style' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={aliStylePrice} onChange={e => setAliStylePrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={aliStyleApiKey} onChange={e => setAliStyleApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址（中国）</label>
                  <input value={aliStyleApiUrl} onChange={e => setAliStyleApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultAliyunVideoGeneration} />
                </div>
              </div>
              <div className="mt-6">
          ...
          {selectedKey === 'aliyun_videoretalk' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={aliRetalkPrice} onChange={e => setAliRetalkPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={aliRetalkApiKey} onChange={e => setAliRetalkApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址（中国）</label>
                  <input value={aliRetalkApiUrl} onChange={e => setAliRetalkApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={`${defaultAliyunImage2Video}/`} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'minimaxi_hailuo_23' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={mm23Price} onChange={e => setMm23Price(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={mm23ApiKey} onChange={e => setMm23ApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={mm23ApiUrl} onChange={e => setMm23ApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="https://api.minimaxi.com/v1" />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'minimaxi_hailuo_23_fast' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={mm23FastPrice} onChange={e => setMm23FastPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={mm23FastApiKey} onChange={e => setMm23FastApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={mm23FastApiUrl} onChange={e => setMm23FastApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="https://api.minimaxi.com/v1" />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'minimaxi_hailuo_02' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={mm02Price} onChange={e => setMm02Price(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={mm02ApiKey} onChange={e => setMm02ApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={mm02ApiUrl} onChange={e => setMm02ApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="https://api.minimaxi.com/v1" />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'minimaxi_speech_26_hd' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={mmSpeechPrice} onChange={e => setMmSpeechPrice(e.target.value)} className="w-full px-4 py-2 bg-background-dark border border-border-dark rounded-lg text白" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={mmSpeechApiKey} onChange={e => setMmSpeechApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={mmSpeechApiUrl} onChange={e => setMmSpeechApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="https://api.minimaxi.com/v1" />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'sora_image' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={soraImagePrice} onChange={e => setSoraImagePrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={soraImageApiKey} onChange={e => setSoraImageApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={soraImageApiUrl} onChange={e => setSoraImageApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultSoraApiUrl} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'sora_video' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={soraVideoPrice} onChange={e => setSoraVideoPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={soraVideoApiKey} onChange={e => setSoraVideoApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="sk-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={soraVideoApiUrl} onChange={e => setSoraVideoApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultSoraApiUrl} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'vidu_q2_pro' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={viduQ2ProPrice} onChange={e => setViduQ2ProPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={viduQ2ProApiKey} onChange={e => setViduQ2ProApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="vidu-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={viduQ2ProApiUrl} onChange={e => setViduQ2ProApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultViduApiUrl} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'vidu_q2_pro_fast' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={viduQ2ProFastPrice} onChange={e => setViduQ2ProFastPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key <span className="text-xs text-slate-500">（留空使用 waule-api）</span></label>
                  <input value={viduQ2ProFastApiKey} onChange={e => setViduQ2ProFastApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="vidu-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={viduQ2ProFastApiUrl} onChange={e => setViduQ2ProFastApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultViduApiUrl} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'vidu_q2_turbo' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={viduQ2TurboPrice} onChange={e => setViduQ2TurboPrice(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={viduQ2TurboApiKey} onChange={e => setViduQ2TurboApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="vidu-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={viduQ2TurboApiUrl} onChange={e => setViduQ2TurboApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultViduApiUrl} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
          ...
          {selectedKey === 'vidu_q2' && (
            <div className="bg-white dark:bg-card-dark border border-slate-200 dark:border-border-dark rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">价格（美元/次）</label>
                  <input type="number" step="0.0001" value={viduQ2Price} onChange={e => setViduQ2Price(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white" />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">API Key</label>
                  <input value={viduQ2ApiKey} onChange={e => setViduQ2ApiKey(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder="vidu-..." />
                </div>
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-slate-700 dark:text-gray-300 mb-2">接口地址</label>
                  <input value={viduQ2ApiUrl} onChange={e => setViduQ2ApiUrl(e.target.value)} className="w-full px-4 py-2 bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-lg text-slate-900 dark:text-white font-mono" placeholder={defaultViduApiUrl} />
                </div>
              </div>
              <div className="mt-6">
                <div className="text-sm font-bold text-slate-900 dark:text-white mb-3">可接受的输入</div>
