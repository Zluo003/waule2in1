          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              <label className="text-[10px] uppercase font-bold tracking-wider text-slate-400 dark:text-white/50">
                提示词 <span className="text-neutral-400 font-normal">（输入@调用角色）</span>
              </label>
                ...
                <div className="flex gap-2 flex-wrap">
                  {referenceImages.map((img, index) => (
                    <div
                      ...
                      className={`nodrag relative w-16 h-16 rounded-md border-2 overflow-hidden transition-all ${generationType === '首尾帧' ? 'cursor-move' : ''} ${draggedImageIndex === index ? 'opacity-50' : ''} border-slate-200 dark:border-white/10 hover:border-neutral-400 dark:hover:border-neutral-400/50`}
                    >
                      <img
              ...
              <div className="space-y-1">
                ...
                <div className="relative py-1.5">
                  <input
                    ...
                    className="nodrag w-full appearance-none cursor-pointer disabled:cursor-not-allowed disabled:opacity-60 bg-transparent [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-neutral-500 [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-md [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-neutral-500 [&::-moz-range-thumb]:border-0 [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:shadow-md [&::-webkit-slider-runnable-track]:w-full [&::-webkit-slider-runnable-track]:h-1 [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-runnable-track]:bg-transparent [&::-moz-range-track]:w-full [&::-moz-range-track]:h-1 [&::-moz-range-track]:rounded-full [&::-moz-range-track]:bg-transparent"
                    style={{
                      backgroundImage: `linear-gradient(to right, #525252 ${durationProgress}%, #3b0764 ${durationProgress}%)`,
            ...
            {selectedModel && isSoraModel && (
              <div className="flex items-center justify-between py-1">
                ...
                <button
                  ...
                  className={`nodrag relative w-10 h-5 rounded-full transition-all ${enableBGM ? 'bg-gradient-to-r from-neutral-800 to-neutral-700' : 'bg-slate-300 dark:bg-white/20'}`}
                >
                  <span
            ...
            <button
              ...
              className={`nodrag w-full mt-2 py-2 text-[10px] font-bold rounded-lg border transition-all flex items-center justify-center gap-2 ${isGenerating || !canGenerate ? 'bg-neutral-800 dark:bg-white text-white dark:text-black cursor-not-allowed border-transparent' : 'bg-neutral-800 dark:bg-white text-white dark:text-black shadow-md hover:shadow-lg border-transparent dark:border-white/10 active:scale-95'}`}
            >
              {isGenerating ? (
                <>
